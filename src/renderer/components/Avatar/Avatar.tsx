// thx sir for file https://github.com/franky47/francoisbest.com/blob/next/src/components/SHA256Avatar.tsx
// i hope u dont minds
...
export interface SHA256AvatarProps {
  radiusFactor?: number;
  hash?: string;
  showGrid?: boolean;
  showLabels?: boolean;
...
const Avatar: React.FC<SHA256AvatarProps> = ({
  radiusFactor = 0.42,
